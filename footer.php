				...
				<div class="container">
					...
					<div class="bottom-foot">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<a href="http://www.clublaserena.com/" class=""><img src="<?php bloginfo('stylesheet_directory'); ?>/imag/logo-5estrellas.svg" class="img-responsive logo-img" /></a>
						</div>
						...
						<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
							<a href="http://www.clublaserena.com/" class="hotel-laserena"><img src="<?php bloginfo('stylesheet_directory'); ?>/imag/logo/club.png" class="img-responsive logo-img" /></a>
						</div>
					</div>
				</div>
			</footer>
